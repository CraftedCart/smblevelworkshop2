/**
 * @file
 * @brief Header for the SMB1LzExporter class
 */

#ifndef SMBLEVELWORKSHOP2_WS2LZ_SMB1LZEXPORTER_HPP
#define SMBLEVELWORKSHOP2_WS2LZ_SMB1LZEXPORTER_HPP
...
namespace WS2Lz {
     ...
     *
     * LZ Specs: https://craftedcart.github.io/SMBLevelWorkshop/documentation/index.html?page=lzFormat1
     *
     ...
     * - Reflective models
     */
    class WS2LZ_EXPORT SMB1LzExporter {
        protected:
            //Constants
            const unsigned int FILE_HEADER_LENGTH = 160;
            const unsigned int START_LENGTH = 20;
            const unsigned int FALLOUT_LENGTH = 4;
            const unsigned int COLLISION_HEADER_LENGTH = 196;
            ...
            const unsigned int LEVEL_MODEL_LENGTH = 12;
