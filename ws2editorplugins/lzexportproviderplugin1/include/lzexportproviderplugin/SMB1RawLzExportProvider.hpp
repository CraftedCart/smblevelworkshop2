...
#ifndef SMBLEVELWORKSHOP2_WS2EDITORPLUGINS_LZEXPORTPROVIDERPLUGIN_SMB1RAWLZEXPORTPROVIDER_HPP
#define SMBLEVELWORKSHOP2_WS2EDITORPLUGINS_LZEXPORTPROVIDERPLUGIN_SMB1RAWLZEXPORTPROVIDER_HPP
...
namespace WS2EditorPlugins {
    namespace LzExportProviderPlugin {
        class SMB1RawLzExportProvider : public WS2Editor::IExportProvider {
            Q_OBJECT

            public:
                virtual QString getTranslatedTypeName() override;
                virtual QVector<QPair<QString, QString>> getNameFilters() override;
                virtual WS2Common::Result<void, QString> checkProject(WS2Editor::Project::Project *project) override;
