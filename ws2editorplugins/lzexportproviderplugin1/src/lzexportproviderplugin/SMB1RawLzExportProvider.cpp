...
namespace WS2EditorPlugins {
    namespace LzExportProviderPlugin {
        ...
        QString SMB1RawLzExportProvider::getTranslatedTypeName() {
            return tr("Super Monkey Ball 1 Raw LZ [*.lz.raw] (Needs to be compressed before usable in-game)");
        }

        QVector<QPair<QString, QString>> SMB1RawLzExportProvider::getNameFilters() {
        ...
        void SMB1RawLzExportProvider::exportFiles(QStringList targetFiles, Project *project) {
